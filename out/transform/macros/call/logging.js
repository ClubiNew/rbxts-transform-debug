...
exports.PrintMacro = {
    ...
    transform: function (state, node) {
        return state.config.enabled
            ? typescript_1.factory.updateCallExpression(node, typescript_1.factory.createIdentifier("print"), undefined, __spreadArray([
...
exports.WarnMacro = {
    ...
    transform: function (state, node) {
        return state.config.enabled
            ? typescript_1.factory.updateCallExpression(node, typescript_1.factory.createIdentifier("warn"), undefined, __spreadArray([
                (0, shared_1.createDebugPrefixLiteral)(node)
            ], node.arguments, true))
            : typescript_1.factory.createVoidExpression(typescript_1.factory.createIdentifier("undefined"));
    },
...
exports.ErrorMacro = {
    ...
    transform: function (state, node) {
        return state.config.enabled
            ? typescript_1.factory.updateCallExpression(node, typescript_1.factory.createIdentifier("error"), undefined, __spreadArray([
